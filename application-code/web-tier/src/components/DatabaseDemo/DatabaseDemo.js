    ...
    class DatabaseDemo extends Component {
        ...
        return (
            <div>
            <h1 id='title' style={{paddingRight:"1em"}}>Database Demo Page</h1><input style={{float:"right", marginBottom:"1em"}} type = "button" value ="DEL" onClick={this.handleButtonClickDel} />
