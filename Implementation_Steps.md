...
```bash
git clone https://github.com/Akshay-Joyboy/aws_3tier_architecture.git
```
...
```bash
curl -o- https://raw.githubusercontent.com/Akshay-Joyboy/aws_3tier_architecture/main/install.sh | bash
source ~/.bashrc
...
sudo rm nginx.conf
sudo aws s3 cp s3://aws-3tier-project/application-code/nginx.conf .
